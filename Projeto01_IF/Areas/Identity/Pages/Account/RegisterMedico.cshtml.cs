...
namespace Projeto01_IF.Areas.Identity.Pages.Account;

public class RegisterModelMedico : PageModel
{
    ...
    public async Task<IActionResult> OnPostAsync(string? returnUrl = null)
    {
        try
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Atribuir a role especifica ao usuário
        ...
        ViewData["IdPlano"] = new SelectList(_context.TbPlano, "IdPlano", "Nome", Input.tbProfissional.IdContratoNavigation.IdPlano);
